...
void ProjectionDemo::Update()
{
	...
	Context::Get()->GetViewport()->Project(&projection2D, Position, W, V, P );

	Gui::Get()->RenderText(projection2D.x, projection2D.y, 1, 0, 0, "AirPlane");
	...
	for (UINT i = 0; i < kachujin->GetTransformCount(); i++)
	{
		...
		Vector3 attachedLocation;
		Context::Get()->GetViewport()->Project(&attachedLocation, Vector3(0, 0, 0), attach, V, P);
		Gui::Get()->RenderText(attachedLocation.x, attachedLocation.y, 0 ,0, 1, "HAND");
