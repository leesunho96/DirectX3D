...
UINT TextureSamplerDemo::filter = 0;
UINT TextureSamplerDemo::address = 0;
...
void TextureSamplerDemo::Initialize()
{
	...
	vertices[0].Uv = Vector2(0, 1.5);
	vertices[1].Uv = Vector2(0, 0);
	vertices[2].Uv = Vector2(1.5, 1.5);
	vertices[3].Uv = Vector2(1.5, 0);
...
void TextureSamplerDemo::Render()
{
	...
	//shader->DrawIndexed(0, 2, 6); //Addresss
}
